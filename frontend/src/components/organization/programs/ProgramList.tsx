    ...
    <>
      <div className="space-y-6">
        {programs.map((program) => (
          <div 
            key={program.id} 
            className="rounded-2xl border border-[#e6ddd4] bg-white p-6 hover:border-[#d4c5b3] transition-all hover:shadow-sm"
          >
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1 min-w-0">
                ...
                {/* Description */}
                {program.description && (
                  <p className="text-sm text-[#6d6760] leading-relaxed mb-5 line-clamp-2">
                    {program.description}
                  </p>
                )}

                {/* Metadata */}
                <div className="flex flex-wrap items-center gap-8 text-sm pt-4 border-t border-[#e6ddd4]">
              ...
              <div className="flex-shrink-0 flex items-center gap-2">
                <button
                  ...
                  className="rounded-full border border-[#d8d0c8] px-5 py-2.5 text-sm font-semibold text-[#2d2a26] transition hover:border-[#c8bfb6] hover:bg-[#fcfaf7]"
                >
                  View Details
                </button>
                ...
                <div className="relative" ref={openDropdownId === program.id ? dropdownRef : null}>
                  <button
                    ...
                    className="rounded-full border border-[#d8d0c8] p-2.5 text-[#2d2a26] transition hover:border-[#c8bfb6] hover:bg-[#fcfaf7]"
                  >
                  ...
                  {openDropdownId === program.id && (
                    <div className="absolute right-0 mt-2 w-48 rounded-xl border border-[#e6ddd4] bg-white shadow-lg z-10">
                      {isArchived ? (
                        <>
                          ...
                          <button
                            ...
                            className="flex w-full items-center gap-3 px-4 py-3 text-sm text-[#2d2a26] transition hover:bg-[#faf6f1]"
                          >
                          ...
                          <button
                            ...
                            className="flex w-full items-center gap-3 px-4 py-3 text-sm text-[#b42318] transition hover:bg-[#fff2f1]"
                          >
                            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
